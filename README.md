...
- Source maps are generated by esbuild before this plugin rewrites emitted
  JavaScript.
- If `sourcemap` is enabled, emitted source maps may not match the transformed
  code.
- For reliable debugging, disable source maps or regenerate them after this
  plugin's transform.
